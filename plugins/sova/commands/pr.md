...
## Synopsis
```
/sova:pr <issue_reference>
```

## Description

Create a pull request with the standard template, analyzing all commits and changes on the current branch.
