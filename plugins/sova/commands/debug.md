...
example: "/sova:debug Login returns 500 when the email has a plus sign"
category: meta
inputs:
  - issue_description
outputs:
...
```
/sova:debug Login returns 500 when the email has a plus sign
```
