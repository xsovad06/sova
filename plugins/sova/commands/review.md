...
Run the full CI-equivalent checks: `the project's CI-equivalent check command (see its Makefile, package.json scripts, or CI config)`. If any check fails, fix the issue and loop back to Step 6.
