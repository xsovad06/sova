...
Run the project's lint command: `the project's lint command (see its Makefile, package.json scripts, or CI config)`
...
Run the project's test command: `the project's test command (see its Makefile, package.json scripts, or CI config)`
