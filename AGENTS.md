...
sova/
  sova/                            # Python package (SOVA)
    ...
    dashboard/                     # FastAPI web UI
      app.py                       # App factory
      routers/                     # 30 API routers (overview, runs, costs, briefing, control, feed, handoff, lifecycle, memory, logs, tasks, queue, quota, settings, setup, agents, work, roles, spec, prs, dependencies, dependency_health, resources, supervisor, oversight, fleet_manager, fleet_insights, telemetry, a2a, mcp)
