...
_REGISTRY: list[SettingMeta] = [
    ...
    SettingMeta(
        "confidence.enabled",
        "Enabled",
        "Compute an LLM-generated confidence score (0-100) for each PR after CI passes",
        "confidence",
        "boolean",
    ),
    SettingMeta(
        "confidence.gate_enabled",
        "Gate on score",
        "Let the score influence handoff routing (advisory-only when disabled)",
        "confidence",
        "boolean",
    ),
    SettingMeta(
        ...
        "Score at or above which a PR is flagged as an auto-merge candidate",
        "confidence",
        "number",
    ),
    SettingMeta(
        ...
        "Review threshold",
        "Score at or above which a PR proceeds to normal review",
        "confidence",
        "number",
    ),
    SettingMeta(
        "confidence.critical_threshold",
        "Critical threshold",
        "Score below which a PR is flagged as critical risk",
        "confidence",
        "number",
    ),
    SettingMeta(
    ...
    SettingMeta(
        ...
        "Max budget (USD)",
        "Maximum spend per confidence scoring call",
        "confidence",
        "number",
    ),
    # -- Watch --
    ...
    SettingMeta(
        "ldap.uid_attribute",
        "UID attribute",
        "Directory attribute holding a person's unique id (uid for Red Hat LDAP, sAMAccountName for AD)",
        "ldap",
    ),
    SettingMeta(
        "ldap.allow_insecure",
        "Allow insecure",
        "Allow a non-ldaps:// server URI (development directories only)",
        "ldap",
        "boolean",
    ),
    SettingMeta(
        "ldap.ca_cert_file",
        "CA cert file",
        "PEM CA bundle path for validating the server certificate (empty uses the system trust store)",
        "ldap",
    ),
    SettingMeta(
        "ldap.team_mapping",
        "Team mapping",
        "Maps a technical area/component label to an LDAP group cn for assignee resolution",
        "ldap",
        "object",
    ),
    SettingMeta(
        "ldap.uid_mapping",
        "UID mapping",
        "Maps a github_user to its LDAP uid when the two identifiers differ",
        "ldap",
        "object",
    ),
    # -- Security --
    ...
    SettingMeta(
        ...
        "Require CI passed",
        "Block PR integration unless all CI checks have passed (on by default)",
        "integration",
        "boolean",
    ),
    SettingMeta(
        ...
        "Require SOVA review",
        "Block PR integration unless SOVA reviewer has approved (on by default)",
        "integration",
        "boolean",
    ),
    SettingMeta(
        ...
        "Block PR integration unless CodeRabbit has reviewed: approved or commented (off by default)",
        "integration",
        "boolean",
    ),
    SettingMeta(
        ...
        "Block PR integration unless all review conversation threads are resolved (on by default)",
        "integration",
        "boolean",
    ),
    SettingMeta(
